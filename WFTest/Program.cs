...
namespace WFTest
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //var work_reus = Common.WorkFlowAppHelper.LoadWorkflowApplication(workflow_temp,Guid.Parse("fcc19c2c-5af9-4da3-a9c8-64c997adbeaf"));
            //work_reus.ResumeBookmark("TempBookMarkName",);
            ...
            //1 创建工作流
            //1.1 此处为为创建的工作流输入的参数
            dic = new Dictionary<string, object>() { { "temp", "1987" } };
