...
namespace SMSFactory
{
    public class MMSQuery:SMSQuery,IMMSQuery
    {
        ...
        /// <returns></returns>
        public QueryState_Enum GetQueryState(List<MMSModel_QueryReceive> list)
        {
            if (list.Count == 1)
            {
        ...
        /// <returns></returns>
        public bool QueryMsg(MMSModel_Query smsdata, out List<MMSModel_QueryReceive> list_receiveModel)
        {
            ...
            //此处有问题           
            list_receiveModel = ObjTransform.Xml2Model_queryReceiveMsg(returnMsg, smsdata);
