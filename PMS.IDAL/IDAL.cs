...
namespace PMS.IDAL
{
   #region IActionInfoDAL   
    ...
    /// 2 接口中的方法不需要添加访问修饰符（public），且没有方法体，只有方法签名
    /// </summary>
	public interface IFdfsContentDAL:IBaseDAL<FdfsContent>
    {
    }
	#endregion
    ...
    /// 2 接口中的方法不需要添加访问修饰符（public），且没有方法体，只有方法签名
    /// </summary>
	public interface IFdfsStorageDAL:IBaseDAL<FdfsStorage>
    {
    }
	#endregion
    ...
    /// 2 接口中的方法不需要添加访问修饰符（public），且没有方法体，只有方法签名
    /// </summary>
	public interface IFdfsTrackerDAL:IBaseDAL<FdfsTracker>
    {
    }
	#endregion
