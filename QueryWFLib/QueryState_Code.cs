...
namespace QueryWFLib
{
    ...
    public sealed class QueryState_Code : CodeActivity
    {
        ...
        private void ToQueryList(CodeActivityContext context,Func<CodeActivityContext,PMS.IModel.SMSModel.IQuerySign, PMS.Model.Enum.QueryState_Enum> toQuery)
        {
           ...
           var queryState_enum= toQuery(context,queryMsg);
            //赋值
            context.SetValue(State,(int)queryState_enum);
        }
        ...
        private PMS.Model.Enum.QueryState_Enum ToQueryFunc_MMS(CodeActivityContext context,PMS.IModel.SMSModel.IQuerySign sign)
        {
            ...
            //6 查询发送状态
            List<MMSModel_QueryReceive> list_QueryReceive_mms;
