...
namespace QueryWFLib {
    ...
    public partial class MMSStatistics_Activity : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(MMSStatistics_Activity).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(MMSStatistics_Activity));
        ...
        private string FindResource() {
            string[] resources = typeof(MMSStatistics_Activity).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".MMSStatistics_Activity.g.xaml") || resource.Equals("MMSStatistics_Activity.g.xaml"))) {
                    return resource;
                }
            }
